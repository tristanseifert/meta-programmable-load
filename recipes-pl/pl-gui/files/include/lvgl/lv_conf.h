 ...
 */
#ifndef LOAD_GUI_LV_CONF_H
#define LOAD_GUI_LV_CONF_H
...
/*
 * Disable some warning diagnostics that lvgl source code isn't entirely clean for
 */
...
#define LV_USE_FS_POSIX 1
    ...
    #define LV_FS_POSIX_PATH "/usr/share/load-gui/"         /*Set the working directory. File/directory paths will be appended to it.*/
...
#define LV_USE_FREETYPE 1
    ...
    #define LV_FREETYPE_CACHE_SIZE (64 * 1024)
        ...
        #define LV_FREETYPE_CACHE_FT_SIZES 16
    #endif
#endif
