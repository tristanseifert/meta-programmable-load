 ...
 * @file
 *
 * @brief User interface deamon RPC type definitions
 *
 * @remark These must be kept in sync manually with the loadd definitions.
 */
#ifndef PINBALLD_RPCTYPES_H
#define PINBALLD_RPCTYPES_H
